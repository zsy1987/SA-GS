...
def readMultiScale(path, white_background,split, only_highres=False,resolution_str='d0.png'):
    cam_infos = []
    ...
    for idx, relative_path in enumerate(meta['file_path']):
        ...
        #     continue
        if only_highres and not relative_path.endswith(resolution_str):
            continue
...
def readMultiScaleNerfSyntheticInfo(path, white_background, eval, load_allres=False,resolution_str="d0.png"):
